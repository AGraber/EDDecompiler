...
import Instruction.ActionOpTableEDZERO as edzero
...
class BattleActionScriptInfo:
    ...
    def DisassembleCraftActions(self, fs):
        ...
        disasm = Disassembler(edzero.edzero_as_op_table, self.DiasmInstructionCallback)
...
for op, inst in edzero.edzero_as_op_table.items():
...
def OpCodeHandler(op, args):
    entry = edzero.edzero_as_op_table[op]
